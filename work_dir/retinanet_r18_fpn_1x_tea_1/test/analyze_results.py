...
def parse_args():
    ...
    parser.add_argument('--config', help='test config file path', default=r'D:\jht_code\mmdetection_git\mmdetection\configs\tea_data\retinanet_r18_fpn_1x_tea_1.py')##################
    # parser.add_argument(
    #     'prediction_path', help='prediction path where test pkl result')
    parser.add_argument(
        '--prediction_path', help='prediction path where test pkl result', default=r'D:\jht_code\mmdetection_git\mmdetection\work_dir\retinanet_r18_fpn_1x_tea_1\test\test_epoch_50\epoch_50.pkl')###########

    # parser.add_argument(
    #     'show_dir', help='directory where painted images will be saved')
    parser.add_argument(
        '--show_dir', help='directory where painted images will be saved', default=r'D:\jht_code\mmdetection_git\mmdetection\work_dir\retinanet_r18_fpn_1x_tea_1\analyze_results')##############
