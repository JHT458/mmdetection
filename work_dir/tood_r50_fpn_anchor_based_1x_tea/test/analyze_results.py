...
# import sys
# sys.path.append(['D:\\anaconda\\envs\\torch\\python39.zip', 'D:\\anaconda\\envs\\torch\\DLLs', 'D:\\anaconda\\envs\\torch\\lib', 'D:\\anaconda\\envs\\torch', 'D:\\anaconda\\envs\\torch\\lib\\site-packages', 'D:\\anaconda\\envs\\torch\\lib\\site-packages\\pycocotools-2.0-py3.9-win-amd64.egg'])
    ...
    def _save_image_gts_results(self,
        ...
        for performance_info in performances:
            ...
            if task == 'det':
                ...
                # gt_instances.bboxes = results[index]['gt_instances']['bboxes']  # 于2023年7月8日注释
...
def parse_args():
    ...
    parser.add_argument('--config', help='test config file path', default=r'D:\jht_code\mmdetection_git\mmdetection\configs\tea_data\tood_r50_fpn_anchor-based_1x_tea.py')
    # parser.add_argument(
    #     'prediction_path', help='prediction path where test pkl result')
    parser.add_argument(
        '--prediction_path', help='prediction path where test pkl result', default=r'D:\jht_code\mmdetection_git\mmdetection\work_dir\tood_r50_fpn_anchor_based_1x_tea\test\test_epoch_50\epoch_50.pkl')

    # parser.add_argument(
    #     'show_dir', help='directory where painted images will be saved')
    parser.add_argument(
        '--show_dir', help='directory where painted images will be saved', default=r'D:\jht_code\mmdetection_git\mmdetection\work_dir\tood_r50_fpn_anchor_based_1x_tea\analyze_results_')
...
if __name__ == '__main__':
    ...
    # import pickle
    # f = open(r'D:\jht_code\mmdetection_git\mmdetection\work_dir\faster_rcnn_r50_fpn_1x_tea_1\test\test_epoch_50\epoch_50.pkl', 'rb')
    # info = pickle.load(f)
    # print(info)

    '''
    1 测试Faster R - CNN 并可视化结果，保存图片至 results /
    ...
    # print(sys.path)
    '''
    ['D:\\jht_code\\mmdetection_git\\mmdetection\\work_dir\\faster_rcnn_r50_fpn_1x_tea_1\\test', 
    'D:\\jht_code\\mmdetection_git\\mmdetection', 
    'D:\\anaconda\\envs\\torch\\python39.zip', 
    'D:\\anaconda\\envs\\torch\\DLLs', 
    'D:\\anaconda\\envs\\torch\\lib', 
    'D:\\anaconda\\envs\\torch', 
    'D:\\anaconda\\envs\\torch\\lib\\site-packages', 
    'D:\\anaconda\\envs\\torch\\lib\\site-packages\\pycocotools-2.0-py3.9-win-amd64.egg']
