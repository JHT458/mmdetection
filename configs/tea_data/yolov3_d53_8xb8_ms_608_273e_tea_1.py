_base_ = ['../_base_/schedules/schedule_1x.py', '../_base_/default_runtime.py', '../_base_/datasets/coco_detection.py',]
# model settings
...
train_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='D:\\jht_datasets\\tea\\img1_2\\annotations\\instance_train.json',
